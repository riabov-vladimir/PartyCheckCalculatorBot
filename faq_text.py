...
_Ситуация: кто\-то забил болта на данную команду\. Так как боты в телеге не умеют считывать список участников чата, этот бот будет знать только про тех пользователей которые вносили расходы, а тех кто не нажал кнопочку и не платил ни за кого не попадут в финальный расчет и не будут скидывать деняк\._
...
_Ситуация: вас попросили по дороге на дачу заехать за ящиком водки\. На водку должны скинуться все, а заплатили вы\. Соответственно эти расходы будут добавлены в общий список и распределены между всеми участниками чата\._ 
...
_Ситуация: уже третий раз кто\-то из компании заказывает сет из 40 шотов в Killfish баре, а вы вдруг вспомнили, что вся компания \- нищеброды \(кроме вас конечно\)\. Запрашиваете промежуточный итог и каждый у себя на телефоне видит уведомление с текстом "Расходы 2900 р\. с человека\. Общая сумма\.\.\.", ну вы поняли, тактичный способ намекнуть, что пора выпиливаться с бара и идти обносить бабушкин сервант на настойку из черноплодки\._
...
_Ситуация: у вас давно сформировавшаяся компания и чатик от встречи к встрече вы не удаляете\. Не забывайте нажимать "Обнуление", чтобы каждую новую встречу создавалась новая сессия расчетов\._
...
_Ситуация: вы единственный курящий в компании человек, но когда покупали в Дикси куриные жепы, зацепили себе блок Донского табака, а в расходы добавили конечно же весь чек\. Ничего страшного, после того как получили леща от друзей спортиков, можете смело воспользоваться данной командой и указать стоимость блока сигарет \- она не будет учитываться при расчетах на компанию\._

🆘 Инструкция к боту

Выводит информацию о боте и его командах\.

_Ситуация: вы немножечко тугой и читаете описание команды, которая вывела вам описание команд \- у вас отлично получится играть на бас\-гитаре ✨_
"""